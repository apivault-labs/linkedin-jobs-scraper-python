...
Open a [GitHub issue](https://github.com/apivault-labs/linkedin-jobs-scraper-python/issues)
with:
- Python version (`python --version`)
- SDK version (`pip show linkedin-jobs-scraper`)
...
```bash
git clone https://github.com/apivault-labs/linkedin-jobs-scraper-python.git
cd linkedin-jobs-scraper-python
python -m venv .venv
